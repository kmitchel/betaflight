...
// PG_GYRO_CONFIG
    ...
    { "dyn_glpf_max_hz",            VAR_UINT16  | MASTER_VALUE, .config.minmax = { 0, 1000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, dyn_glpf_max_hz) },
    { "dyn_glpf_min_hz",            VAR_UINT16  | MASTER_VALUE, .config.minmax = { 0, 1000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, dyn_glpf_min_hz) },
    { "dyn_glpf_idle",              VAR_UINT16  | MASTER_VALUE, .config.minmax = { 0, 100 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, dyn_glpf_idle) },
    { "dyn_dlpf_max_hz",            VAR_UINT16  | MASTER_VALUE, .config.minmax = { 0, 1000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, dyn_dlpf_max_hz) },
    { "dyn_dlpf_min_hz",            VAR_UINT16  | MASTER_VALUE, .config.minmax = { 0, 1000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, dyn_dlpf_min_hz) },
    { "dyn_dlpf_idle",              VAR_UINT16  | MASTER_VALUE, .config.minmax = { 0, 100 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, dyn_dlpf_idle) },
#endif
